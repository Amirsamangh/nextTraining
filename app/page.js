        ...
        <div className="row">
          ...
          <div className="col-lg-7 col-12">
            <div className="hero-text">
              ...
              <h2 className="mb-4 dir_rtl text_3xl px-5 py-4">من، امیرسامان، یه برنامه نویس فرانت اند هستم. به وبسایت من خوش اومدی</h2>
          ...
          <div className="col-lg-5 col-12 position-relative">
            <div className="hero-image-wrap  position-static">
              <img src="/assets/images/logos/js.png" className=" img-fluid hero_logo_1" alt="" />
              <img src="/assets/images/logos/react.png" className=" img-fluid hero_logo_2 animation_spin" alt="" />
              <img src="/assets/images/logos/next.png" className=" img-fluid hero_logo_3 d-none d-lg-block" alt="" />
            </div>
          </div>
