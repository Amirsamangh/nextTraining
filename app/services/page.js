            ...
            <div className="row">
                ...
                <div className="col-lg-10 col-12 mx-auto">
                    <div className="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                        <img src="/assets/images/handshake-man-woman-after-signing-business-contract-closeup.jpg" className="avatar-image img-fluid" alt=""/>
                    ...
                    <div className="row pt-lg-5">
                        ...
                        <div className="col-lg-6 col-12">
                            <div className="services-thumb services-thumb-up mt-4">
                                <div className="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
